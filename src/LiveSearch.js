/**
 * Plugin to add search functionality to a grid.
 */
Ext.define('Ext.ux.grid.plugin.LiveSearch', {
    ...
    init: function(grid) {
        ...
        grid.searchMatches    = Ext.bind(this.search, this);
    ...
    updateSearchRegExp: function(value) {
        ...
        Ext.defer(this.search, 1, this);
    },

    /**
     * Retry search after search string has changed.
     */
